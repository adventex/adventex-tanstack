...
const tourSearchSchema = z.object({
  type: z.enum(["study", "travel"]).default("study"),
  duration: z.enum(["short-term", "long-term"]).optional(),
  location: z.string().optional(),
  price: z.number().optional(),
})

type TourSearch = z.infer<typeof tourSearchSchema>
...
export const Route = createFileRoute("/tours/")({
  ...
  validateSearch: (search) => tourSearchSchema.parse(search),
